...
# v18.0.0 以上が表示されればOK`}
          ...
          <InfoBox type="warning" title="Node.js が未インストールの場合">
            ...
            先に「<a href="/environment/nodejs" class="text-primary hover:underline">Node.js インストール</a>」ページの手順を完了してください。
          </InfoBox>
        </div>
...
> この場所に hello.txt というファイルを作って、中に「Hello World!」と書いて`}
        ...
        <div className="flex justify-between items-center pt-8 border-t border-border">
          ...
          <Button className="gap-2" onClick={() => (window.location.href = '/ai-agent/claude-code-basics')}>
            次へ：Claude Code 基本操作
            <ArrowRight size={20} />
          </Button>
        </div>
