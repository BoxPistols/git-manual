    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="flex justify-between items-center pt-8 border-t border-border">
          <Button variant="outline" onClick={() => window.location.href = "/environment/cursor"}>戻る</Button>
          <Button className="gap-2" onClick={() => window.location.href = "/environment/nodejs"}>
              次へ：Node.js をインストール
